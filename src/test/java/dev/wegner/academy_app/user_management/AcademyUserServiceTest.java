...
class AcademyUserServiceTest
{
    ...
    void shouldCreateUser()
    {
        ...
        var savedUser = AcademyUser.create("admin", "hashedPassword", true, AcademyRole.ADMIN);

        when(academyUserRepository.save(any())).thenReturn(savedUser);

        var result = academyUserService.createUser("admin", "academy", AcademyRole.ADMIN);
        ...
        assertThatThrownBy(() ->
                academyUserService.createUser("admin", "academy", AcademyRole.ADMIN)).isInstanceOf(IllegalArgumentException.class)
    ...
    void shouldFindUserByUsername()
    {
        ...
        var result = academyUserService.findByUsername("admin");
    ...
    void shouldThrowExceptionWhenUserNotFound()
    {
        ...
        assertThatThrownBy(() -> academyUserService.findByUsername("unknown")).isInstanceOf(IllegalArgumentException.class)
